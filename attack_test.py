...
# attackpath = 'attack_defense'+defense+str(grad_prune_rate)+'bn'+str(bn_reg)+'tv'+str(tv_weight)+resultpath
...
org = torch.load(resultpath+'/images/batch0_org.pt', map_location='cpu').to(setup['device'])
